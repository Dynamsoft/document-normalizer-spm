...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "DynamsoftLicense", url: "https://download2.dynamsoft.com/xcframeworks/dynamsoft-license-ios-3.2.21-xcframework.zip", checksum: "5356001d4d51c5a9efd84efa8513192bfd2a01a7afb697ddc8118a97bc5369ea"),
